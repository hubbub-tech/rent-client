      ...
      <div className="container-md my-5">
        <div className="row">
          ...
          <div className="col-sm-8 col-12">
            <h1>Confirmation</h1>
            <p>We've received your pickup request.</p>
            ...
            <div className="row mt-5">
              ...
              <div className="col-md-11 col-12 my-2">
                <p className="fs-2 mb-5 text-md-start text-center align-middle">We'll set a time for one of our couriers to pick your order up!</p>
              </div>
