...
import { ExtendReturnToFeedButton } from './ExtendReturnToFeedButton';

import { FlashContext } from '../../../providers/FlashProvider';


export const ExtendCancelPage = () => {
      ...
      <div className="container-md my-5">
        <div className="row">
          ...
          <div className="col-sm-8 col-12">
            <h1>Cancelled Extension</h1>
            <p>Your extension did not go through.</p>
            <hr />
